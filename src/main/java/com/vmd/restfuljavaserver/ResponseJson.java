...
public class ResponseJson {
    ...
    public static ResponseEntity<ResponseJson> getError() {
    ...
    public static ResponseEntity<ResponseJson> getError(String error) {
        Map<String,Object> attributes = new HashMap<>();
    ...
    public static ResponseEntity<ResponseJson> getOk() {
        Map<String,Object> attributes = new HashMap<>();
